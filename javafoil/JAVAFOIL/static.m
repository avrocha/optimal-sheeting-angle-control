...
%     K             = 0.0750; % gain (>0 since extremum is maximum)
    ...
    [sheet_angle, cT, cT_grad] = gbesc(J, dt, N, f, A, fc_hp, fc_lp, K, sheet_angle_0, lp_bool);
...
if lp_bool 
    dir = strcat('plots\', ES_method,'_ESC\static_', num2str(n),'D\lpf\');
else
    dir = strcat('plots\', ES_method,'_ESC\static_', num2str(n),'D\wout_lpf\');
end
