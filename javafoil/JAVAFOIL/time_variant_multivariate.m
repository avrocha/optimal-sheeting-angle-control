...
if strcmp(ES_method, 'GB')
    ...
    [sheet_angle, cT, cT_grad] = gbesc(J, dt, N, f, A, fc, K, sheet_angle_0, AWA);
...
%% Functions
function [u, y, dy] = gbesc(J, dt, N, f, A, fc, K, u0, AWA)
...
function [u, y, dy, ddy, ddy_inv] = nbesc(J, dt, N, f, A, fc, K, u0, wric, ddy0, AWA)
    % Gradient-based extremum seeking controller for 1D static maps
    % Inputs:
    % - J    : optimization criterion [function handle]
    % - dt   : simulation step [s]
